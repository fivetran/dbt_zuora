...
-- this test ensures the zuora__line_item_enhanced end model matches the prior version
with prod as (
    select {{ dbt_utils.star(from=ref('zuora__line_item_enhanced'), except=exclude_cols) }}
