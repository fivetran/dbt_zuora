...
final as (
    ...
    select
        ...
        row_number() over (partition by account_id {{ fivetran_utils.partition_by_source_relation(package_name='zuora') }} order by created_date desc) = 1 as is_most_recent_account_contact
    from fields
