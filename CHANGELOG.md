...
- Removed the dependency on the `fivetran/zuora_source` package.
  ...
  - Update any zuora_source-scoped variables to be scoped to only under this package. See the [README](https://github.com/fivetran/dbt_zuora/blob/main/README.md) for how to configure the build schema of staging models.
